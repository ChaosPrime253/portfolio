        ...
        <div className="contact__grid">
          <div className="contact__info">
            ...
            <div className="contact__links">
              ...
              <a href="https://github.com/ChaosPrime253" target="_blank" rel="noreferrer" className="contact__link">
              ...
              <a href="https://www.linkedin.com/in/yourusername" target="_blank" rel="noreferrer" className="contact__link">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
